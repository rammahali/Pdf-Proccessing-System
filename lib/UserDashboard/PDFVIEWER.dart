...
class _PDFVIEWERState extends State<PDFVIEWER> {
              ...
              children: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: SfPdfViewer.asset('sample.pdf'),
                  ),
                ),
                SizedBox(
                  width: 30,
                ...
                Container(
                  ...
                  child: ListView(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          cardWidget(
                              ...
                              Colors.deepOrange,
                              "Title",
                              "Pdf proccessing system"),
                          SizedBox(
                            width: 15,
                          ),
                          cardWidget(Icons.apps_sharp, Colors.white,
                              Colors.pink, "Type", "Bittirme projesi"),
                        ],
                      ),
                      SizedBox(
                        height: 20,
                      ...
                      Row(
                        children: [
                          cardWidget(Icons.date_range, Colors.white,
                              Colors.indigo, "Semester", "Winter 2020-2021"),
                          SizedBox(
                            width: 15,
                          ),
                          cardWidget(
                              ...
                              Colors.green,
                              "Keywords",
                              "Pdf , data , processing ,Kocaeli , system"),
                        ],
                      ),
                      SizedBox(
                        height: 20,
                      ...
                      Row(
                        children: [
                          summaryWidget(Icons.add_link, Colors.white,
                              Colors.teal, "Summary", summary),
                        ],
                      )
                    ],
                  ),
  ...
  Widget cardWidget(IconData icon, Color themeColor, Color backgroundColor,
        ...
        children: [
          Row(
            children: [
              ...
              Text(
                title,
                style: GoogleFonts.aBeeZee(color: themeColor, fontSize: 20),
              )
            ],
          ),
          SizedBox(
  ...
  Widget summaryWidget(IconData icon, Color themeColor, Color backgroundColor,
      String title, String text) {
    var screenWidth = MediaQuery.of(context).size.width;
    return Container(
      padding: EdgeInsets.symmetric(horizontal: 13, vertical: 30),
